...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Helped ship the 0.1 to 0.4 alpha versions of the VSceneCreator (Unity/C\#) by suggesting, designing and implementing features, addressing bugs, and creating tests through close collaboration with Product Management.}
      ...
      \resumeSubheading
      {Working Student Software Engineer}{Mar. 2021 -- Oct. 2024}
